...
@app.on_message(filters.command(["addidhayan"], prefixes=["/", "!", "."]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["delidhayan", "rmidhayan"], prefixes=["/", "!", "."]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["idhayanlist", "listidhayan", "idhayansudoers"], prefixes=["/", "!", "."]) & ~BANNED_USERS)
