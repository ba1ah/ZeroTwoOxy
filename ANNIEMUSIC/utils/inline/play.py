...
def panel_markup_1(_, videoid, chat_id):
    buttons = [
        [
            InlineKeyboardButton(text= "𝐀ᴅᴅ 𝐈ɴ 𝐘ᴏᴜʀ 𝐏ʟᴀʏʟɪsᴛ 🔊", callback_data=f"add_playlist {videoid}")
        ],
        [
            InlineKeyboardButton(text="𝐒ʜᴜғғʟᴇ", callback_data=f"ADMIN Shuffle|{chat_id}",),
            InlineKeyboardButton(text="𝐋ᴏᴏᴘ", callback_data=f"ADMIN Loop|{chat_id}"),
        ],
        [
            InlineKeyboardButton(text="◁ 10 𝐒ᴇᴄ", callback_data=f"ADMIN 1|{chat_id}",),
            InlineKeyboardButton(text="10 𝐒ᴇᴄ ▷", callback_data=f"ADMIN 2|{chat_id}",),
        ],
        [
            InlineKeyboardButton(text="𝐇ᴏᴍᴇ 🔺", callback_data=f"MainMarkup {videoid}|{chat_id}",),
            InlineKeyboardButton(text="𝐍ᴇxᴛ 🔻", callback_data=f"Pages Forw|0|{videoid}|{chat_id}",),
        ],
    ]
    return buttons
